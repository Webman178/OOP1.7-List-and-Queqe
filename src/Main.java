...
//        moskvich.refill();
        ...
        Transport lada = new Car("Лада ", "Веста", 1.6,ivan, mechanics);
        ...
        Transport bmw = new Truck("БМВ ", "Пегас", 4.6, vasya,mechanics);
       /* Truck volvo = new Truck("Волво ", "Империал", 5.0, Weight.N2);
        ...
        Transport toyota = new Bus("Тойота ", "Мэн", 3.6, lesha, mechanics);
        ...
        for (Transport ts: race) {
            System.out.println(ts.getDriver());
            ts.printMechanics();
        }
